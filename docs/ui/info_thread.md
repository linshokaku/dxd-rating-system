...
- `match_format` を選ばずに `ランキングを表示` button を押した場合は、ランキング表示は行わず、押下ユーザーに `マッチ形式を選択してください。再度操作するには、情報確認チャンネルのボタンから新しい情報確認用スレッドを作成してください。` を返す。
...
- `match_format` を選ばずに `ランキングを表示` button を押した場合は、ランキング表示は行わず、押下ユーザーに `マッチ形式を選択してください。再度操作するには、情報確認チャンネルのボタンから新しい情報確認用スレッドを作成してください。` を返す。
- `season_id` と `match_format` の両方を選ばずに `ランキングを表示` button を押した場合は、ランキング表示は行わず、押下ユーザーに `シーズンとマッチ形式を選択してください。再度操作するには、情報確認チャンネルのボタンから新しい情報確認用スレッドを作成してください。` を返す。
