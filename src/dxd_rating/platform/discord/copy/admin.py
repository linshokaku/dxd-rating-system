...
ADMIN_INVALID_RESETUP_CONFIRM_MESSAGE = "confirm が不正です。"
ADMIN_RESETUP_UI_CHANNEL_SUCCESS_MESSAGE = "指定した UI チャンネルを再セットアップしました。"
ADMIN_RESETUP_UI_CHANNEL_NOT_INSTALLED_MESSAGE = "指定した UI は未設置です。"
...
ADMIN_RESETUP_UI_CHANNEL_COMMAND_DESCRIPTION = "指定した UI 設置チャンネルを再セットアップします"
ADMIN_RESETUP_UI_CHANNEL_UI_TYPE_DESCRIPTION = "再セットアップしたい UI の種別"
ADMIN_RESETUP_UI_CHANNEL_CONFIRM_DESCRIPTION = "再セットアップする場合は resetup を入力"
...
def build_admin_unrestriction_public_message(
    ...
    return f"{PLAYER_ACCESS_RESTRICTION_TYPE_LABELS[restriction_type]}制限を解除しました。"
...
def build_admin_penalty_public_message(
    ...
    return f"{penalty_label}ペナルティを{adjustment}しました。現在の累積: {count}"
