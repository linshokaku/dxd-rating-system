...
DEV_MATCH_ACTION_FAILED_MESSAGE = (
    "ダミーユーザーのマッチ操作に失敗しました。管理者に確認してください。"
)
...
DEV_MATCH_PARENT_COMMAND_DESCRIPTION = "ダミーユーザーをマッチの親に立候補させます"
DEV_MATCH_SPECTATE_COMMAND_DESCRIPTION = "ダミーユーザーにマッチの観戦応募をさせます"
...
DEV_MATCH_VOID_COMMAND_DESCRIPTION = "ダミーユーザーに無効マッチを報告させます"
